...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='yolov7-baseline', help='save to project/name')
    ...
    parser.add_argument('--save_period', type=int, default=-5, help='Log model after every "save_period" epoch')
